...
!(function () {
    if (!window.TradingView || !window.TradingView.host || window.TradingView.reoloadTvjs) {
        var e,
            ...
            r,
            s,
            a = { "color-brand": "#2196f3", "color-gull-gray": "#9db2bd", "color-scooter": "#38acdb", "color-curious-blue": "#299dcd" },
            d = {
                ...
                QuotesProvider: function (e) {
                    var t,
                        i,
                        o = d.gId(),
                        n = ((e = { container: e.container_id, symbols: e.symbols || [], type: "quotes-provider", useWidgetHost: e.useWidgetHost }), d.getHost(e) + "/embed-quotes-provider/?" + d.generateUtmForUrlParams(e));
                    function r(e) {
                        var o = e.symbol,
                            n = e.success,
                            r = e.error;
                    ...
                    l('<iframe id="' + o + '" src="' + n + '" width="0" height="0" frameborder="0" allowTransparency="true" scrolling="no"></iframe>', e.container),
        ...
        (d.DependenciesManager = function () {}),
            ...
            (d.DependenciesManager.prototype.depends = function (e, t, i) {
                for (var o = 0; o < e.length; o++)
                    this.scripts[e[o]] && !0 === this.scripts[e[o]].status
                        ...
                        : ((this.scripts[e[o]] = { status: !1, script: document.createElement("script"), callbacks: {} }),
                          (this.scripts[e[o]].callbacks[t] = i),
                          (this.scripts[e[o]].script.onload = this._loaded.bind(this, e[o])),
                ...
                generateUrl: function (e) {
                    ...
                    return (
                        ...
                        (e.enable_publishing ? d.ideasHost : d.getHost(e)) +
                            ...
                            o("calendar", "1") +
                            o("hotlist", "1") +
                            (e.studies && d.isArray(e.studies) ? ("string" == typeof e.studies[0] ? o("studies", encodeURIComponent(e.studies.join(""))) : n("studies", e.studies)) : "") +
                            i("horztouchdrag") +
                            i("verttouchdrag") +
            ...
            (d.showSignIn = function (e, t) {
                d.dependenciesManager.depends(["/static/bundles/spinner.js"], "authWidget", function () {
                    ...
                    i.appendChild(o),
                        new window.Spinner().setStyle({ color: "#00A2E2", opacity: "0" }).spin(o),
                        (i.style.cssText = "position: fixed;left: 0;top: 0;width: 100%;height: 100%;background: rgba(0, 0, 0, 0.5);z-index: 120;-webkit-transform: translate3d(0, 0, 0);"),
                        i.addEventListener("click", function () {
                            document.body.removeChild(i);
                        }),
                        document.body.appendChild(i);
                    var n = d.gId(),
                        r = d.createUrlParams({ id: n, utmSourceOverride: e.utmSourceOverride }),
